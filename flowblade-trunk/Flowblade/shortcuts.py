...
def _set_keyboard_action_names():
    ...
    _keyboard_action_names['clear_mark_in'] =  _("Clear Mark In")
    _keyboard_action_names['clear_mark_out'] =  _("Clear Mark Out")
    _keyboard_action_names['play'] = _("Play")
    ...
    _keyboard_action_names['open_prev'] =  _("Open Previous Media Item In Monitor")
