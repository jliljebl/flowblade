...
def init_script(fctx):
    ...
    fctx.add_editor("1Ball Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("11Ball Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba2ll Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba3ll Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1B4all Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba5ll Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba6ll Size", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("11Ball S9ize", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba2ll S9ize", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba3ll Si9ze", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1B4all S9ize", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba5ll S9ize", fctx.EDITOR_INT_RANGE, (330, 10, 800))
    fctx.add_editor("1Ba6ll Si9ze", fctx.EDITOR_INT_RANGE, (330, 10, 800))
