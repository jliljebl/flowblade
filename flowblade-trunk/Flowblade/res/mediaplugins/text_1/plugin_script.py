...
def init_script(fctx):
    ...
    fctx.add_editor("Animation Type In", fluxity. EDITOR_OPTIONS, \
                    (9, ["From Left Clipped", "From Right Clipped", "From Up Clipped", \
                        "From Down Clipped", "From Left", "From Right", "From Up", \
                        "From Down", "Zoom In", "Zoom Out", "Typewriter Letter", "Typewriter Word"]))
    ...
    fctx.add_editor("Animation Type Out", fluxity. EDITOR_OPTIONS, \
                    (3, ["From Left Clipped", "From Right Clipped", "From Up Clipped", \
                        "From Down Clipped", "From Left", "From Right", "From Up", \
                        "From Down", "Zoom In", "Zoom Out", "Typewriter Letter", "Typewriter Word"]))
...
class LineText:
    ...
    def _create_animations(self, fctx, bg_area):
        ...
        anchor_x, anchor_y = self._get_in_animation_affine_data(fctx, bg_area)
        ...
        # Animation Out
        start_x, start_y, end_x, end_y, start_scale, end_scale, \
        anchor_x, anchor_y = self._get_out_animation_affine_data(fctx, bg_area)
