...
def _get_dynamic_kb_shortcuts_panel(xml_file, tool_set):   
    ...
    general_vbox.pack_start(_get_dynamic_kb_row(root_node, "zoom_fit"), False, False, 0)
    ...
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "lift"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "rippledelete"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "rangedelete"), False, False, 0)
    ...
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "copyaction"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "pasteaction"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "pastefiltersaction"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "toggle_audio_mute"), False, False, 0)
    tline_vbox.pack_start(_get_dynamic_kb_row(root_node, "add_dissolve"), False, False, 0)
    ...
    sync_box.pack_start(_get_dynamic_kb_row(root_node, "resync_selected"), False, False, 0)
    sync_box.pack_start(_get_dynamic_kb_row(root_node, "set_sync_relation"), False, False, 0)
    sync_box.pack_start(_get_dynamic_kb_row(root_node, "set_sync_selected"), False, False, 0)
