...
def main(root_path, session_id, media_file_id, proxy_w, proxy_h, enc_index, \
            proxy_file_path, proxy_rate, media_file_path, profile_desc):
        
    mltheadlessutils.mlt_env_init(root_path, session_id)

    ccrutils.prints_to_log_file("/home/janne/proxylog")

    print(media_file_id, proxy_w, proxy_h, enc_index, proxy_file_path, proxy_rate, media_file_path, profile_desc)
...
class ProxyClipRenderThread(threading.Thread):
    ...
    def __init__(self, media_file_id, proxy_w, proxy_h, enc_index, 
                    proxy_file_path, proxy_rate, media_file_path, proxy_profile_desc):
