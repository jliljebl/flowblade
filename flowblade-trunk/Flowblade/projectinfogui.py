...
def get_top_level_project_info_panel():
    ...
    project_name_label = guiutils.bold_label(PROJECT().name)
    name_row = guiutils.get_left_justified_box([project_name_label])
    ...
    vbox.pack_start(guiutils.pad_label(8, 12), False, False, 0)
    vbox.pack_start(guiutils.get_left_justified_box([desc_label]), False, False, 0)
    vbox.pack_start(info_box, False, False, 0)
    vbox.pack_start(guiutils.pad_label(8, 12), False, False, 0)
    vbox.set_margin_top(4)
    #profile_panel = guiutils.get_named_frame(_(""), vbox, 4)
    #name_panel = guiutils.get_named_frame(_("Project"), vbox, 4)
    ...
    #project_info_vbox.pack_start(name_panel, False, True, 0)
    #project_info_vbox.pack_start(profile_panel, False, True, 0)
    #project_info_vbox.set_size_request(250, PROJECT_TOP_LEVEL_PANE_HEIGHT)
