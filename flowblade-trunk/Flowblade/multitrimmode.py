...
import gi
from gi.repository import Gdk # gi.require_version("Gdk X.0") needs to called?
...
def mouse_press(event, frame):
    _enter_trim_mode_edit(event.x, event.y, frame, event)
