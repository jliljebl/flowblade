...
def about_dialog(parent_window):
    ...
    ver_label = Gtk.Label(label="2.12.0.2")
    janne_label = Gtk.Label(label="Copyright 2023 Janne Liljeblad and contributors.")
...
def _get_dynamic_kb_shortcuts_panel(xml_file, tool_set):   
    ...
    tline_vbox.pack_start(_get_kb_row(_("Shift + Left Arrow "), _("Back 10 Frames Trim Edit")), False, False, 0)
    tline_vbox.pack_start(_get_kb_row(_("Shift + Right Arrow"), _("Forward 10 Frames Trim Edit")), False, False, 0)
