...
class EditorWindow:
    ...
    def _init_app_menu(self, ui):
        ...
        menu_actions = [
            ...
            ('CreateFluxityContainerItem', None, _("From Flowblade Plugin Script"), None, None, lambda a:containerclip.create_fluxity_media_item()),
            ...
            ('Scripttool', None, _("Scripting Tool"), None, None, lambda a:scripttool.launch_scripttool()),
