...
class EditorWindow:
    ...
    def _init_view_menu(self, menu_item):
        ...
        interp_nearest = gtk.RadioMenuItem(None, _("Nearest Neighbour (fast)").encode('utf-8'))
        ...
        interp_bilinear = gtk.RadioMenuItem(interp_nearest, _("Bilinear (good)").encode('utf-8'))
        ...
        interp_bicubic = gtk.RadioMenuItem(interp_nearest, _("Bicubic (better)").encode('utf-8'))
        ...
        interp_hyper = gtk.RadioMenuItem(interp_nearest, _("Hyper/Lanczos (best)").encode('utf-8'))
