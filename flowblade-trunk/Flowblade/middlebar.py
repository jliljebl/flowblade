...
def _create_buttons(editor_window):
    ...
    tooltips = [_("Split Audio Synched"), _("Set Sync for All Clips on Track Containing Selected Clip/s"), _("Resync Track Containing Selected Clip/s"), _("Resync Selected Clip")]
