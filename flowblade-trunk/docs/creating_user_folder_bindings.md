...
Let's call this directory **\<ROOT_DIR\>**. Open terminal in this directory. If you have previous */build* and */install* dirs in **<ROOT_DIR>** delete those.
...
```bash
cmake -DCMAKE_BUILD_TYPE=Release -DSWIG_PYTHON=ON -DMOD_GLAXNIMATE_QT6=OFF -DMOD_GLAXNIMATE=OFF -DMOD_QT=OFF -DMOD_QT6=OFF -DMOD_MOVIT=OFF -DMOD_OPENCV=ON -DMOD_SDL2=ON -DMOD_SPATIALAUDIO=OFF -DMOD_RUBBERBAND=ON -S ./mlt -B ./build
...
2. Create a launch script in to set up MLT variables correctly on launch.
