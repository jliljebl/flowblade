...
| [Stop using GtkEventBox](https://developer-old.gnome.org/gtk4/stable/ch41s02.html#id-1.7.4.4.22)                                                                      | 14 instances, use indirection builder func, needs more work port time.          |
...
| [Widgets are now visible by default](https://developer-old.gnome.org/gtk4/stable/ch41s02.html#id-1.7.4.4.47)                                                                                                                                                                                                                                                                                                                                                                 | show() is no-op on init now, hide() may need to be added somewhere,  show_all() 171 instances can be easily with scripts.                                                                                                                                                                                                                      |
| [GtkWidget event signals are removed](https://developer-old.gnome.org/gtk4/stable/ch41s02.html#id-1.7.4.4.51)                                                                                                                                                                                                                                                                                                                                                                | "clicked" 100+ places, "button-press-event" needed for e.g. timeline, lots of work here.                                                                                                                                                                                                                                                       |
